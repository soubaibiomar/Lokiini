...
from app.routers import auth, equipment, bookings, kyc, inspections, webhooks, contracts, messages, abonnements
...
app.include_router(abonnements.router, prefix=settings.API_V1_STR)
app.include_router(contracts.router, prefix=settings.API_V1_STR)
app.include_router(webhooks.router, prefix=settings.API_V1_STR)

# Also mount directly at root for clean path alias support
